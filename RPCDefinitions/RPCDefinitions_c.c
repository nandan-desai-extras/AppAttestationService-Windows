...
static const RPC_CLIENT_INTERFACE RPCDefinitions___RpcClientInterface =
    {
...
RPC_IF_HANDLE RPCDefinitions_v1_0_c_ifspec = (RPC_IF_HANDLE)& RPCDefinitions___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE RPCDefinitions__MIDL_AutoBindHandle;
    ...
    /* [size_is][size_is][out] */ unsigned char **idBinding)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RPCDefinitions_StubDesc,
                  (PFORMAT_STRING) &RPCDefinitions__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&AIKname);
    ...
    /* [size_is][size_is][out] */ unsigned char **serverSecret)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RPCDefinitions_StubDesc,
                  (PFORMAT_STRING) &RPCDefinitions__MIDL_ProcFormatString.Format[66],
                  ( unsigned char * )&AIKname);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [string][in] */ wchar_t *AIKname)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RPCDefinitions_StubDesc,
                  (PFORMAT_STRING) &RPCDefinitions__MIDL_ProcFormatString.Format[126],
                  ( unsigned char * )&AIKname);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [size_is][size_is][out] */ unsigned char **attestationBlob)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RPCDefinitions_StubDesc,
                  (PFORMAT_STRING) &RPCDefinitions__MIDL_ProcFormatString.Format[162],
...
static const MIDL_STUB_DESC RPCDefinitions_StubDesc = 
    {
    (void *)& RPCDefinitions___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hExample1Binding,
    0,
